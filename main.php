...
Type /cmds to know all my commands!</b>",
    ...
    'reply_markup'=>json_encode(['inline_keyboard' => [
        [
          ['text' => "💠 Created By 💠", 'url' => "tg://user?id=1764351005"]
        ],
        [
          ['text' => "💎 Join 💎", 'url' => "t.me/team_zeon"]
        ],
...
if(strpos($message, "/cmds") === 0 || strpos($message, "!cmds") === 0 || strpos($message, ".cmds") === 0){
    ...
    'reply_to_message_id'=> $message_id,
    'reply_markup'=>json_encode(['inline_keyboard'=>[
    [['text'=>"GATES",'callback_data'=>"checkergates"]],[['text'=>"TOOLS",'callback_data'=>"othercmds"]],
    ],'resize_keyboard'=>true])
    ]);
...
𝗝𝗢𝗜𝗡 <a href='t.me/badboy_checkers1'>𝗛𝗘𝗥𝗘</a>",
    'parse_mode'=>'html',
